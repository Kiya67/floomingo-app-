...
export default function UploadExperienceScreen() {
  ...
  const handleAddPlace = useCallback(() => {
    ...
    if (!trimmed) return;
    console.log("User added place to experience:", trimmed);
  ...
  const handleRemovePlace = useCallback((placeId: string) => {
    console.log("User removed place from experience:", placeId);
  ...
  const handleSubmit = useCallback(async () => {
    ...
    console.log("User tapped Post Experience - submitting experience upload");
    setSubmitting(true);
    try {
