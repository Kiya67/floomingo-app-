...
export default function AddScreen() {
  ...
  const handlePostMoment = async () => {
    console.log("User tapped Share button — Moment", { hasVideo: !!videoUri, captionLength: caption.length, locationsCount: selectedLocations.length });
  ...
  const handlePostExperience = async () => {
    console.log("User tapped Share button — Experience", { hasVideo: !!videoUri, titleLength: title.length });
    if (!videoUri) { Alert.alert("No video", "Please select a video first."); return; }
