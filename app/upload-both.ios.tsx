...
async function generateAndUploadThumbnail(
  ...
  try {
    ...
    console.log("Thumbnail generated at (iOS):", thumbResult.uri);
    return await uploadBlobToSupabase(thumbResult.uri, bucket, path, "image/jpeg");
  } catch (err: any) {
    console.warn("Thumbnail generation/upload failed (iOS, continuing without thumbnail):", err?.message);
    return null;
  }
}
...
export default function UploadBothScreen() {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      console.log("(iOS) Uploading moment video to 'posts' and experience video to 'experiences' in parallel");
      ...
      console.log("(iOS) Generating and uploading thumbnails in parallel");
      ...
      console.log("(iOS) Posting moment to /api/moments and experience to /api/experiences in parallel");
      await Promise.all([
      ...
      console.log("Both uploads successful (iOS)");
