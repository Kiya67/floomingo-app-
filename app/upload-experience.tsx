...
export default function UploadExperienceScreen() {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    console.log("User tapped Post Experience - submitting multipart upload");
    setSubmitting(true);
    try {
      ...
      console.log("Experience upload response status:", response.status);
      ...
      console.log("Experience posted successfully:", data);
