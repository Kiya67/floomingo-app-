...
export default function HomeScreen() {
  ...
  useEffect(() => {
    ...
    if (hasPlaceFilter || hasKeywordsFilter) {
      console.log('Received filters from navigation:', { filterPlaceId: params.filterPlaceId, filterPlaceName: params.filterPlaceName, filterKeywords: params.filterKeywords });
      if (hasPlaceFilter) {
      ...
      console.log('Received clear filters signal from navigation');
      setFilterPlaceId(null);
      setFilterPlaceName(null);
      setFilterKeywords(null);
    }
  ...
  const handlePostPress = (post: Post) => {
    console.log('User tapped video grid item:', post.id);
