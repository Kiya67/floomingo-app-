...
import { View, Text, StyleSheet, TouchableOpacity, useColorScheme, ActivityIndicator, Dimensions, StatusBar, Image, ImageSourcePropType, FlatList, Share, TextInput, Modal, Alert, ScrollView, Animated } from 'react-native';
...
const PANEL_HEIGHT = height * 0.72;
...
const expStyles = StyleSheet.create({
  ...
  panel: { position: 'absolute', bottom: 0, left: 0, right: 0, height: PANEL_HEIGHT, backgroundColor: '#0F0F14', borderTopLeftRadius: 24, borderTopRightRadius: 24, zIndex: 11, borderTopWidth: 1, borderColor: 'rgba(255,105,180,0.15)' },
  handle: { width: 36, height: 4, borderRadius: 2, backgroundColor: 'rgba(255,255,255,0.25)', alignSelf: 'center', marginTop: 10 },
  panelHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20, paddingTop: 12, paddingBottom: 8 },
  panelTitleRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  panelLabel: { fontSize: 13, fontWeight: '700', color: '#FF69B4', letterSpacing: 1, textTransform: 'uppercase' },
  ...
  experienceTitle: { fontSize: 22, fontWeight: '700', color: '#FFFFFF', letterSpacing: -0.3, marginTop: 4, lineHeight: 30 },
  creatorText: { fontSize: 13, color: 'rgba(255,255,255,0.5)', marginTop: 4 },
  ratingRow: { flexDirection: 'row', alignItems: 'center', gap: 3, marginTop: 10, marginBottom: 4 },
  ratingText: { fontSize: 13, color: 'rgba(255,255,255,0.6)', marginLeft: 4 },
  section: { marginTop: 24 },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 12 },
  sectionTitle: { fontSize: 15, fontWeight: '700', color: '#FFFFFF' },
  placeRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 6, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.06)' },
  placeDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#FF69B4' },
  placeText: { fontSize: 14, color: 'rgba(255,255,255,0.85)' },
  dayBlock: { marginBottom: 16 },
  dayLabel: { fontSize: 13, fontWeight: '700', color: '#FF69B4', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
  itineraryItem: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, paddingVertical: 4 },
  itineraryDot: { width: 5, height: 5, borderRadius: 2.5, backgroundColor: 'rgba(255,255,255,0.4)', marginTop: 7 },
  itineraryText: { fontSize: 14, color: 'rgba(255,255,255,0.75)', lineHeight: 20, flex: 1 },
  bookingCard: { backgroundColor: 'rgba(255,105,180,0.08)', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: 'rgba(255,105,180,0.2)' },
  bookingPriceRow: { flexDirection: 'row', alignItems: 'baseline', gap: 4 },
  bookingPrice: { fontSize: 24, fontWeight: '700', color: '#FFFFFF' },
  bookingPer: { fontSize: 13, color: 'rgba(255,255,255,0.5)' },
  bookingNote: { fontSize: 12, color: 'rgba(255,255,255,0.5)', marginTop: 6, marginBottom: 14, lineHeight: 17 },
  bookButton: { backgroundColor: '#FF69B4', borderRadius: 12, paddingVertical: 14, alignItems: 'center' },
  bookButtonText: { fontSize: 15, fontWeight: '700', color: '#FFFFFF' },
  relatedCard: { width: 120, marginRight: 12 },
  relatedThumb: { width: 120, height: 80, borderRadius: 10, backgroundColor: 'rgba(255,255,255,0.08)', marginBottom: 6 },
  relatedName: { fontSize: 12, color: 'rgba(255,255,255,0.75)', lineHeight: 16 },
});
  ...
  return (
    <GestureHandlerRootView style={styles.container}>
      ...
      <ExperiencesPanel
        ...
        onClose={() => {
          console.log('User closed Experiences panel (iOS video)');
