...
export default function UploadExperienceScreen() {
  ...
  const handlePickVideo = useCallback(async () => {
    console.log("User tapped pick video for experience upload");
    ...
    if (!result.canceled && result.assets[0]) {
      ...
      console.log("User selected video for experience:", asset.uri, "duration:", durationSecs, "s");
    }
  }, []);
  ...
  const handleSubmit = useCallback(async () => {
    ...
    console.log("User tapped Post Experience - submitting Supabase Storage upload");
    setSubmitting(true);
    try {
      ...
      console.log("Step 1: Uploading experience video to Supabase Storage bucket 'experiences'");
      ...
      try {
        console.log("Step 2: Generating thumbnail from experience video");
        ...
        console.warn("Thumbnail generation/upload failed (continuing without thumbnail):", thumbErr?.message);
      }
      ...
      console.log("Posting experience to /api/experiences:", payload);
      ...
      console.error("Upload experience error:", e);
