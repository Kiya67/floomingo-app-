...
export default function AddScreen() {
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      console.log('Step 4: Uploading video to video_public bucket (iOS)');
      ...
      console.log('Step 8: Uploading thumbnail to video_public bucket (iOS)');
      ...
      console.log('Step 9: Creating post via backend API with public URLs and', selectedLocations.length, 'locations (iOS)');
