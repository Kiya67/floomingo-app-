...
export default function UploadTypeScreen() {
  ...
  const handleMoment = useCallback(() => {
    console.log("User tapped Moment on upload-type screen (iOS)");
    router.push("/upload-moment");
  }, [router]);

  const handleExperience = useCallback(() => {
    console.log("User tapped Experience on upload-type screen (iOS)");
    router.push("/upload-experience");
  }, [router]);

  const handleBoth = useCallback(() => {
    console.log("User tapped Both on upload-type screen (iOS)");
    router.push("/upload-both");
  }, [router]);

  const handleClose = useCallback(() => {
    console.log("User tapped close on upload-type screen (iOS)");
    router.back();
  }, [router]);
